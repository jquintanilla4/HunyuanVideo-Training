...
def parse_args():
    ...
    group = parser.add_mutually_exclusive_group() # either control_scale or constant must be set
    group.add_argument("--control_scale", type=float,
                       default=None,
                       help="Max dynamic scale for control latents (uses schedule if set)")
    group.add_argument("--constant", type=float,
                       default=None,
